...
set (HEADER_PATH ${CMAKE_CURRENT_SOURCE_DIR}/soloud/include)
set (SOURCE_PATH ${CMAKE_CURRENT_SOURCE_DIR}/soloud/src)

set (LINK_LIBRARIES)

list(APPEND CMAKE_MODULE_PATH ${CMAKE_CURRENT_SOURCE_DIR}/soloud/contrib/FindSDL2.cmake)
...
include (${CMAKE_CURRENT_SOURCE_DIR}/soloud/contrib/Install.cmake)
